...
namespace Machine\Datatable;

use Machine\Cylinders\Read;
use Machine\Cylinders\Show;
...
class Datatable extends Model
{
    ...
    {
        $tableField = (new Show())->table($this->select) . 'Datatable' . (new Show())->pk($this->select);
