...
use Machine\Datatable\Datatable;
use Machine\Gears\Repositories;
use Machine\Http\Response;
use Machine\Session\Session;
use Machine\Iginition\Flame;
use Machine\Support\DateFormatter;
use Machine\Support\Env;
use Machine\Valve\Query\BuildsQueries;
...
if (! function_exists('route')) {
    ...
    function route($name, $parameters = [], $absolute = true)
    {
        if ($name == '/'){
            ...
            return config('app.url') .DIRECTORY_SEPARATOR. $name;
        }
    }
}
